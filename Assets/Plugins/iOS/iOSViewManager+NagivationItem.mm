...
extern "C"
{
	...
	void _leftBarButtonItems_set(int tag, int * items, int arrayCount)
	{
        UINavigationItem *navitem = [MHTools getActualObject:tag];
        if(navitem)
        {
            navitem.leftBarButtonItems = [MHTools convertMultipleTagsToNSArray:items num:arrayCount];
            return;
        }
	...
	void _rightBarButtonItems_set(int tag, int * items, int arrayCount)
	{
        UINavigationItem *navitem = [MHTools getActualObject:tag];
        if(navitem)
        {
            navitem.rightBarButtonItems = [MHTools convertMultipleTagsToNSArray:items num:arrayCount];
            return;
        }
	...
	void _setLeftBarButtonItems(int tag, int * items, int arrayCount, bool animated)
	{
        UINavigationItem *navitem = [MHTools getActualObject:tag];
        if(navitem)
        {
            [navitem setLeftBarButtonItems:[MHTools convertMultipleTagsToNSArray:items num:arrayCount] animated:animated];
            return;
        }
	...
	void _setRightBarButtonItems(int tag, int * items, int arrayCount, bool animated)
	{
        UINavigationItem *navitem = [MHTools getActualObject:tag];
        if(navitem)
        {
            [navitem setRightBarButtonItems:[MHTools convertMultipleTagsToNSArray:items num:arrayCount] animated:animated];
            return;
        }
