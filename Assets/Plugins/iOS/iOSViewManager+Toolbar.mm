...
extern "C"
{
	...
	void _items_toolbar_set(int tag, int * items, int arrayCount)
	{
        UIToolbar *toolbar = [MHTools getActualObject:tag];
        if(toolbar)
        {
            toolbar.items = [MHTools convertMultipleTagsToNSArray:items num:arrayCount];
            return;
        }
	...
	void _setItems_toolbar(int tag, int * items, int arrayCount, bool animated)
	{
        UIToolbar *toolbar = [MHTools getActualObject:tag];
        if(toolbar)
        {
            [toolbar setItems:[MHTools convertMultipleTagsToNSArray:items num:arrayCount] animated:animated];
            return;
        }
