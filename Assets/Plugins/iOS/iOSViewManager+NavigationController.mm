...
extern "C"
{
	...
	void _viewControllers_set(int tag, int * viewControllers, int arrayCount)
	{
        UINavigationController *navcontroller = [MHTools getActualObject:tag];
        if(navcontroller)
        {
            NSArray *vc = [MHTools convertMultipleTagsToNSArray:viewControllers num:arrayCount];
	...
	void _setViewControllers(int tag, int * viewControllers, int arrayCount, bool animated)
	{
        UINavigationController *navcontroller = [MHTools getActualObject:tag];
        if(navcontroller)
        {
