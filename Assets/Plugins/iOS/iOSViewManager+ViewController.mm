...
extern "C"
{
	...
	void _setToolbarItems(int tag, int * toolbarItems, int arrayCount, bool animated)
	{
        UIViewController *viewcontroller = [MHTools getActualViewController:tag];
        if(viewcontroller)
        {
            [viewcontroller setToolbarItems:[MHTools convertMultipleTagsToNSArray:toolbarItems num:arrayCount] animated:animated];
            return;
        }
	...
	void _toolbarItems_set(int tag, int * items, int arrayCount)
	{
        UIViewController *viewcontroller = [MHTools getActualViewController:tag];
        if(viewcontroller)
        {
            viewcontroller.toolbarItems = [MHTools convertMultipleTagsToNSArray:items num:arrayCount];
            return;
        }
