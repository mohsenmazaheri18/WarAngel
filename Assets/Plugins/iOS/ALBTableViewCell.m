...
#import "ALBTableViewCell.h"

@implementation ALBTableViewCell
#pragma mark UITableViewCellCallbacks
- (void)willTransitionToState:(UITableViewCellStateMask)state
{
    ...
    NSDictionary *dict = [[NSDictionary alloc] initWithObjectsAndKeys:
                          ...
                          [NSNumber numberWithInt:ste], @"state",
                          nil];
    const char *jsonResult = MakeStringCopy([dict JSONString]);
    
    [iOSViewManager UnitySendInstantMessage:"willTransitionToState" JSONPARAM:jsonResult];
}
...
-(void)didTransitionToState:(UITableViewCellStateMask)state
{
    ...
    [iOSViewManager UnitySendInstantMessage:"didTransitionToState" JSONPARAM:jsonResult];
}
