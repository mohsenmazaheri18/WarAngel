...
public class OptionsController_Graphics : MonoBehaviour {
    ...
    public void gfx_fullScreen()
    {
        ...
        //set values
        ControlFreak2.CFScreen.SetResolution(Screen.width, Screen.height, toggleFullscreen == 1 ? true : false);
   ...
   /// <summary>
    ...
    void gfx_setDefaults()
    {
        ...
        toggleAnisoFilt = PlayerPrefs.GetInt("toggleAnisoFilt",0); 
        toggleVsync = PlayerPrefs.GetInt("toggleVsync",0); 
        toggleShadows = PlayerPrefs.GetInt("toggleShadows",0);
        toggleTextureQuality = PlayerPrefs.GetInt("toggleTextureQuality",1);
        toggleAntiAlias = PlayerPrefs.GetInt("toggleAntiAlias",0);
