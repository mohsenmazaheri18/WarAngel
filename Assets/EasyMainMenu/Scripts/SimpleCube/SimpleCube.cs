...
public class SimpleCube : MonoBehaviour {
	...
	void Update () {
        ...
        {   //standard input
            this.transform.Translate(moveSpeed * ControlFreak2.CF2Input.GetAxis("Horizontal") * Time.deltaTime, 0,
                moveSpeed * ControlFreak2.CF2Input.GetAxis("Vertical") * Time.deltaTime);
        }
