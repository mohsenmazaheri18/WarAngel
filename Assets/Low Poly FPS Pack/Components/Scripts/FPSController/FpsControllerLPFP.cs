...
namespace FPSControllerLPFP
{
    ...
    public GameObject sitt;
    public GameObject Standd;
...
#pragma warning restore 649
        ...
        private void Update()
        {
            ...
            {
               // anim.Play("sit_idle");
                Standd.SetActive(true);
                sitt.SetActive(false);
                anim.SetBool("Sit",true);
            }
            else if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.M))
            {
                //anim.Play("stand_idle");
                Standd.SetActive(false);
                sitt.SetActive(true);
