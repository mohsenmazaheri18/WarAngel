...
public class BoltActionSniperScriptLPFP : MonoBehaviour {
	...
	private void Update () {
        ...
        if (ControlFreak2.CF2Input.GetKeyDown(KeyCode.Alpha3))
        {
            ...
            Gun4.SetActive(false);
            Gun5.SetActive(false);
            timescaleText.text = "Granade_Gun";
        }
		...
		if (ControlFreak2.CF2Input.GetKey (KeyCode.W) && !isRunning && !isShooting || 
			ControlFreak2.CF2Input.GetKey (KeyCode.A) && !isRunning && !isShooting || 
			ControlFreak2.CF2Input.GetKey (KeyCode.S) && !isRunning && !isShooting || 
			ControlFreak2.CF2Input.GetKey (KeyCode.D) && !isRunning && !isShooting) 
		{
